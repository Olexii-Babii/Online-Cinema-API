...
@router.get(
    ...
    description=("<h3>This endpoint allows users to get list of stars.</h3>"),
    responses={
        404: {
...
@router.patch(
    ...
    responses={
        ...
        500: {
            ...
            "content": {
                "application/json": {
                    "example": {"detail": "An error occurred while updating the star."}
                }
            },
        },
    },
...
async def update_star(
    ...
    star_with_same_name = await db.scalar(
...
@router.delete(
    ...
    responses={
        ...
        409: {
            ...
            "content": {
                "application/json": {
                    "example": {"detail": "There are already films with this star."}
                }
            },
        },
        500: {
